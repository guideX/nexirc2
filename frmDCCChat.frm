...
Begin VB.Form frmDCCChat 
   ...
   Begin NexIRC.ctlXPButton cmdHelp 
      ...
      MCOL            =   12632256
      MPTR            =   0
      MICON           =   "frmDCCChat.frx":000C
      PICN            =   "frmDCCChat.frx":0028
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   -1  'True
   ...
   Begin NexIRC.ctlXPButton cmdOK 
      ...
      MCOL            =   12632256
      MPTR            =   0
      MICON           =   "frmDCCChat.frx":29C4A
      PICN            =   "frmDCCChat.frx":29C66
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   -1  'True
   ...
   Begin NexIRC.ctlXPButton cmdCancel 
      ...
      MCOL            =   12632256
      MPTR            =   0
      MICON           =   "frmDCCChat.frx":53888
      PICN            =   "frmDCCChat.frx":538A4
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   -1  'True

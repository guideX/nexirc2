VERSION 5.00
Begin VB.Form frmMessageServer 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "NexIRC - Message Server"
   ClientHeight    =   960
   ClientLeft      =   45
   ClientTop       =   735
   ClientWidth     =   4440
   ...
   EndProperty
   Icon            =   "frmMessageServer.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   960
   ...
   Begin nexIRC.ctlXPButton cmdHelp 
      ...
      MCOL            =   12632256
      MPTR            =   0
      MICON           =   "frmMessageServer.frx":000C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin nexIRC.ctlXPButton cmdSend 
      ...
      MCOL            =   12632256
      MPTR            =   0
      MICON           =   "frmMessageServer.frx":0028
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin nexIRC.ctlXPButton cmdCancel 
      ...
      MCOL            =   12632256
      MPTR            =   0
      MICON           =   "frmMessageServer.frx":0044
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmMessageServer"
...
If lSettings.sHandleErrors = True Then On Local Error Resume Next
DisplayHelpInformation 22
If Err.Number <> 0 Then ProcessRuntimeError Err.Description, Err.Number, "Private Sub cmdCancel_Click()"
End Sub

Private Sub cmdSend_Click()
If lSettings.sHandleErrors = True Then On Local Error Resume Next
lSettings.sActiveServerForm.tcp.SendData txtMessage.Text & vbCrLf
Unload Me

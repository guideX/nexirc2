Attribute VB_Name = "mdlIRCUserCommands"
Option Explicit
...
If Users(Index).Nick = "" Then
    ...
    ChangeNick = True
Else
    Dim i As Long, X As Long, CurChan As clsIRCServer_Channel, CurNick As clsIRCServer_User
...
If SendToChan Then
    Dim i As Long, X As Long, CurChan As clsIRCServer_Channel
...
Else
    Dim cUser As clsIRCServer_User
...
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long, X As Long, CurChan As clsIRCServer_Channel, Found As Boolean
...
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long, Channel As clsIRCServer_Channel
...
Else
    Dim Chan As clsIRCServer_Channel
...
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long, Channel As clsIRCServer_Channel, KickMsg As String
Set Channel = ChanToObject(Chan)
...
Public Sub OpUser(Channel As clsIRCServer_Channel, Target As String, User As String, Optional OpAnyway As Boolean = False, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
...
Public Sub DeOpUser(Channel As clsIRCServer_Channel, Target As String, User As String, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long, Chan As String
...
End Sub
Public Sub VoiceUser(Channel As clsIRCServer_Channel, Target As String, User As String, Optional VoiceAnyway As Boolean = False, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long, Chan As String
Chan = Channel.Name
...
End Sub
Public Sub DeVoiceUser(Channel As clsIRCServer_Channel, Target As String, User As String, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long, Chan As String
...
Public Sub BanUser(Channel As clsIRCServer_Channel, Target As String, User As String, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long
...
Public Sub UnBanUser(Channel As clsIRCServer_Channel, Target As String, User As String, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long
For i = 1 To Channel.All.Count
    SendWsock NickToObject(Channel.All(i)).Index, ":" & User & "!" & NickToObject(User).ID & " MODE " & Channel.Name & " -b " & Target
...
Public Sub RemoveChanModes(NewModes As String, Chan As String, User As clsIRCServer_User, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim Found As Boolean, X As Long, Channel As clsIRCServer_Channel, Modes As String
Set Channel = ChanToObject(Chan)
...
Public Sub AddChanModes(NewModes As String, Chan As String, User As clsIRCServer_User, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim Found As Boolean, X As Long, Channel As clsIRCServer_Channel, Modes As String
If lSettings.sHandleErrors = True Then On Local Error Resume Next
If InStr(1, NewModes, "r") And User.Nick <> "ChanServ" Then NewModes = Replace(NewModes, "r", "")
...
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long, Chan As clsIRCServer_Channel
...
Public Sub InviteUser(Channel As clsIRCServer_Channel, Target As String, User As String, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long
...
Public Sub UnInviteUser(Channel As clsIRCServer_Channel, Target As String, User As String, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long
...
Public Sub ExceptionUser(Channel As clsIRCServer_Channel, Target As String, User As String, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long
...
Public Sub UnExceptionUser(Channel As clsIRCServer_Channel, Target As String, User As String, Optional SendLink As Boolean = True)
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim i As Long

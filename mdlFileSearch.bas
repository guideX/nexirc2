...
If Err.Number <> 0 Then ProcessRuntimeError Err.Description, Err.Number, "Public Sub GetDirs(ByVal sDir As String, DirAttr As VbFileAttribute, cCol As tSearch)"
End Sub
...
Next
cCol.Count = cCol.Path.Count
If Err.Number <> 0 Then ProcessRuntimeError Err.Description, Err.Number, "Public Sub GetSubDirs(ByVal sDir As String, DirAttr As VbFileAttribute, cCol As tSearch)"
End Sub
...
Next
cCol.Count = cCol.Path.Count
If Err.Number <> 0 Then ProcessRuntimeError Err.Description, Err.Number, "Public Sub GetFiles(sDir As String, sFilter As String, FileAttr As VbFileAttribute, cCol As tSearch)"
End Sub
...
cCol.Count = cCol.Path.Count
If Err.Number <> 0 Then ProcessRuntimeError Err.Description, Err.Number, "Public Sub GetSubFiles(sDir As String, sFilter As String, DirAttr As VbFileAttribute, FileAttr As VbFileAttribute, cCol As tSearch)"
End Sub
...
End If
sSplit = nResult
If Err.Number <> 0 Then ProcessRuntimeError Err.Description, Err.Number, "Private Function sSplit(ByVal sStr1 As String, sDelims As String, sResult() As String) As Long"
End Function

...
Begin VB.Form frmStats 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   487
   Begin nexIRC.ctlListView lvwInfo 
      Height          =   2415
      Left            =   1920
      TabIndex        =   5
      Top             =   1680
      ...
      _ExtentY        =   4260
   End
   Begin nexIRC.ctlListView lvwClasses 
      Height          =   2415
      Left            =   0
      TabIndex        =   4
      Top             =   1680
      ...
      _ExtentY        =   4260
   End
   Begin nexIRC.ctlListView lvwItems 
      Height          =   1335
      Left            =   0
      TabIndex        =   3
      Top             =   360
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txtChannel 
         ...
         Width           =   3495
      End
      Begin nexIRC.isButton cmdClose 
         Height          =   300
         Left            =   6240
         TabIndex        =   10
         Top             =   120
...
lSettings.sActiveServerForm.tcp.SendData "PRIVMSG " & txtChannel.Text & " :" & lStatsData & vbCrLf
i = FindChannelIndex(txtChannel.Text)
If i <> 0 Then
    msg = Trim(lStatsData)
    'ProcessReplaceString sOwnMessage, ReturnChannelIncomingTBox(i), txtChannel.Text, lStatsData
    'DoColorChannel i, "<" & lSettings.sNickname & "> " & ReturnStrippedColorCodes(lStatsData)
    DoColorChannel i, "<" & lSettings.sNickname & "> " & lStatsData
    'MsgBox lStatsData
    'MsgBox lStatsData
    'msg = StripColorCodes(msg)
    'msg = ReturnStrippedColorCodes(msg)
    'msg = Replace(msg, vbCrLf, "")
    'MsgBox "!" & msg & "!"
    'DoColor lSettings.sActiveServerForm.txtIncoming, "[FUck] fuioehfoie"
    'msg = Left(msg, 160)
    'DoColorLines lSettings.sActiveServerForm.txtIncoming, msg
    'DoColorChannel i, msg
End If
...
lSettings.sAdvancedSystemStatsVisisble = True
...
'''On Local Error Resume Next
lSettings.sAdvancedSystemStatsVisisble = False
End Sub

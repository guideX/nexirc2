...
Public Type gSelectedFont
    ...
    sFaceName As String
End Type
Global SelectedFont As gSelectedFont
...
Dim ret As Long, Count As Integer, fileNameHolder As String, LastCharacter As Integer, NewCharacter As Integer, tempFiles(1 To 200) As String, hInst As Long, Thread As Long
ParenthWnd = hWnd
...
If ret Then
    If Trim$(FileDialog.sFileTitle) = "" Then
        ...
        For Count = 1 To ShowOpen.nFilesSelected
            ...
            ShowOpen.sFileSize = FileDialog.nFileSize = Len(tempFiles(1))
        Next Count
    Else
...
Dim customcolors() As Byte, i As Integer, ret As Long, hInst As Long, Thread As Long
ParenthWnd = hWnd
...
Public Function ShowFont(ByVal hWnd As Long, ByVal startingFontName As String, Optional ByVal centerForm As Boolean = True) As gSelectedFont
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim ret As Long, lfLogFont As LOGFONT, hInst As Long, Thread As Long, i As Integer
ParenthWnd = hWnd
...
If lSettings.sHandleErrors = True Then On Local Error Resume Next
Dim rectForm As RECT, rectMsg As RECT, X As Long, Y As Long
